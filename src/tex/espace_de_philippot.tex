...
\section*{Note méthodologique sur la correction linguistique}

La correction linguistique de ce chapitre a été réalisée au moyen d’une \emph{chaîne de traitement} dédiée au format TeX, avec un contrôle strict de préservation du sens mathématique. La vérification grammaticale et orthographique a été effectuée en français canadien (fr-CA), puis complétée par une harmonisation terminologique à partir de références officielles Canada/Québec, notamment TERMIUM Plus (gouvernement du Canada) et le Grand dictionnaire terminologique (OQLF). Les propositions n’ont été retenues que si le score de conservation sémantique demeurait au moins égal à 9.6/10, afin de préserver exactement l’intention, l’explication et la portée des énoncés.

Ce processus n’altère pas les contenus de validation formelle HOL ni les expressions mathématiques; il agit uniquement comme levier de qualité rédactionnelle sur les segments textuels admissibles.
