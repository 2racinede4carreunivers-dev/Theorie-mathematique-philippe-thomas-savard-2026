theory analyse_geometrie_spectre_premier
...
(*      1. Forme generale des suites SA et SB ............... 55-62 *)
(*      2. Validite des formes generales pour n > 0 ......... 68-76 *)
(*      3. Rapport spectral 1/2 (definition + preuve) ....... 83-115 *)
(*      4. Generalisation n x n du rapport spectral ......... 122-147 *)
(*      5. Digamma calcule et equation du premier ........... 153-201 *)
(*      6. Postulat spectral 1/2 (axiomatisation) ........... 207-216 *)
(*      7. Exemples : 29, 31, 37, 41 ........................ 221-289 *)
(*                                                              *)
(* II.  MODELE SPECTRAL 1/4                                     *)
(*      1. Definitions generales A_1_4 et B_1_4 ............. 296-312 *)
(*      2. Equation generale du premier (1/4) ............... 318-323 *)
(*      3. Postulat spectral 1/4 (axiomatisation) ........... 330-335 *)
(*      4. Exemple complet : premier 947 ..................... 351-377 *)
(*                                                              *)
(* III. MODELE SPECTRAL 1/3                                     *)
(*      1. Definitions generales A_1_3 et B_1_3 ............. 384-398 *)
(*      2. Equation generale du premier (1/3) ............... 404-409 *)
(*      3. Postulat spectral 1/3 (axiomatisation) ........... 416-420 *)
(*      4. Exemple complet : premier 227 ..................... 437-456 *)
(*      5. Preuve generale du rapport constant 1/3 .......... 461-502 *)
(*                                                              *)
(* IV.  RAPPORT SPECTRAL 1/4 - PREUVE GENERALE                 *)
(*      1. Definition RsP_1_4 ............................... 509-513 *)
(*      2. Preuve du rapport constant 1/4 .................... 514-542 *)
(*                                                              *)
(* V.   SUITES MIXTES A ET B (-,+)                              *)
(*      1. Definitions SA_mix et SB_mix ...................... 548-555 *)
(*      2. Formes fermees et recurrence ...................... 556-580 *)
(*      3. Reconstruction generale du premier (mixte) ........ 583-595 *)
(*      4. Exemple : six termes negatifs ..................... 597-616 *)
(*                                                              *)
(* VI.  SUITES NEGATIVES - EQUATIONS SPECTRALES                 *)
(*      1. Definitions SA_neg_eq et SB_neg_eq ................ 622-629 *)
(*      2. Digamma negatif ................................... 630-636 *)
(*      3. Rapport spectral negatif 1/2 (axiomatisation) ..... 643-657 *)
(*                                                              *)
(* VII. GEOMETRIE SPECTRALE - ASYMETRIE ORDONNEE / CHAOTIQUE    *)
(*      1. Indices valides et croissance stricte (int) ....... 664-672 *)
(*      2. Asymetrie ordonnee et chaotique ................... 673-689 *)
(*      3. Proprietes generales ............................... 691-708 *)
(*                                                              *)
(* VIII. METHODE DE COMPARAISON ASYMETRIQUE                     *)
(*      1. Version nat des asymetries ........................ 741-744+ *)
(*      2. Comparaison asymetrique modele 1/2 ................ (suite) *)
(*      3. Comparaison asymetrique modele 1/4 ................ (suite) *)
(*                                                              *)
(* IX.  AXIOMATISATIONS SPECTRALES - SECTIONS OFFICIELLES       *)
(*                                                              *)
(*      1. Axiomatisation positive (modele 1/2) .............. 207-216 *)
...
(*                                                              *)
(*      4. Axiomatisation negative (rapport spectral 1/2) ..... 643-652 *)
...
(*      2. Aires et geometrie de la droite critique .......... (nouveau) *)
(*      3. Combinatoire des ecarts (simple/mixte) ............ (nouveau) *)
(*      4. Axiomes trifocaux : Zeta / Spectral / RH .......... (nouveau) *)
...
consts
  ...
  Aire_parab                        :: real  (* Aire de la parabole *)
...
consts
  ...
  Com_Pinit_Re  :: real  (* Nombre relatif de comparaisons simples *)
  Com_mixt_Sup  :: real  (* Nombre relatif de comparaisons mixtes (-,+) *)
  Com_ident     :: real  (* Comparaisons identiques (-p, p) *)
...
text ‹
  Les axiomes suivants codent les relations conceptuelles :
    ...
    - l'aire totale T_area est la somme de T_tr_area et T_restant_area,
